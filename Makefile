...
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir)/ruby/backward -I$(hdrdir) -I$(srcdir) -I/usr/local/include/openzwave -I/usr/local/include/openzwave/
DEFS     = 
...
ldflags  = -L. -fstack-protector -L/usr/local/opt/libyaml/lib -L/usr/local/opt/openssl/lib -L/usr/local/opt/readline/lib  -L/usr/local/lib/
...
target_prefix = 
LOCAL_LIBS = 
LIBS = $(LIBRUBYARG_SHARED)  -lopenzwave -lpthread -ldl -lobjc 
ORIG_SRCS = openzwave.cc
SRCS = $(ORIG_SRCS) 
OBJS = openzwave.o
HDRS = 
TARGET = OpenZWave
